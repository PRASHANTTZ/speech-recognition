export KALDI_ROOT=/home/ps/kaldi
...
export LIBLBFGS=/home/ps/kaldi/tools/liblbfgs-1.10
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${LIBLBFGS}/lib/.libs
export SRILM=/home/ps/kaldi/tools/srilm
export PATH=${PATH}:${SRILM}/bin:${SRILM}/bin/i686-m64
export IRSTLM=/home/ps/kaldi/tools/irstlm
